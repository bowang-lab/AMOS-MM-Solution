...
from LaMed.src.dataset.multi_dataset import UniDatasets, CapDataset, TextDatasets, AMOSCapDataset, VQADataset
...
@dataclass
class DataArguments:
    data_root: str = field(default="./Data/", metadata={"help": "Root directory for all data."})

    # caption data
    cap_data_path: str = field(default="Data/M3D_Cap_npy/M3D_Cap.json", metadata={"help": "Path to caption data."})
