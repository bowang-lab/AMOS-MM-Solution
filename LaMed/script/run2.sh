...
PYTHONPATH=. CUDA_VISIBLE_DEVICES="0" accelerate launch --main_process_port 29502 LaMed/src/train/abdomen_train.py \
    --version v0 \
    ...
    --bf16 True \
    --output_dir /scratch/ssd004/datasets/med-img-data/amosmm/trained/any_res_concat_before/ \
    ...
    --use_hilt False \
    --task mrg \
    --concat_after_project False \
    --any_res_crops "[(2, 1, 1)]" \
    --image_size "32, 256, 256" \
    --any_res_image_size "64, 256, 256" \
    --patch_size "4, 16, 16" \
