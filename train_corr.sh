...
JOB_ID=$SLURM_JOB_ID
CUDA_VISIBLE_DEVICES="1,2" PYTHONPATH=. accelerate launch --num_processes 2 --main_process_port 29515 LaMed/src/train/amos_train.py \
    --version v0 \
    ...
    --bf16 True \
    --output_dir  /home/jma/Documents/mohammed/amosmm/models/phi3_150_with_seg2 \
